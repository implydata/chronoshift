...
describe("floor/shift/ceil", () => {
  ...
  it("floors hour correctly", () => {
    expect(shifters.hour.floor(new Date("2012-11-04T00:30:00-07:00"), tz), 'A')
      .toEqual(new Date("2012-11-04T00:00:00-07:00"));

    expect(shifters.hour.floor(new Date("2012-11-04T01:30:00-07:00"), tz), 'B')
      .toEqual(new Date("2012-11-04T01:00:00-07:00"));

    expect(shifters.hour.floor(new Date("2012-11-04T01:30:00-08:00"), tz), 'C')
      .toEqual(new Date("2012-11-04T01:00:00-08:00"));

    expect(shifters.hour.floor(new Date("2012-11-04T02:30:00-08:00"), tz), 'D')
      .toEqual(new Date("2012-11-04T02:00:00-08:00"));

    expect(shifters.hour.floor(new Date("2012-11-04T03:30:00-08:00"), tz), 'E')
      .toEqual(new Date("2012-11-04T03:00:00-08:00"));
  });
  ...
  it("shifts hour over DST 1", () => {
    expect(shifters.hour.floor(new Date("2012-11-04T00:05:00-07:00"), tz)).toEqual(new Date("2012-11-04T00:00:00-07:00"));
    expect(shifters.hour.floor(new Date("2012-11-04T01:05:00-07:00"), tz)).toEqual(new Date("2012-11-04T01:00:00-07:00"));
    expect(shifters.hour.floor(new Date("2012-11-04T02:05:00-07:00"), tz)).toEqual(new Date("2012-11-04T02:00:00-07:00"));
    expect(shifters.hour.floor(new Date("2012-11-04T03:05:00-07:00"), tz)).toEqual(new Date("2012-11-04T03:00:00-07:00"));
  });
