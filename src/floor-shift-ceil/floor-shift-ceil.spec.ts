...
describe('floor/shift/ceil', () => {
  ...
  it('floors hour correctly', () => {
    expect(shifters.hour.floor(new Date('2012-11-04T00:30:00-07:00'), tz), 'A').toEqual(
      new Date('2012-11-04T00:00:00-07:00'),
    );

    expect(shifters.hour.floor(new Date('2012-11-04T01:30:00-07:00'), tz), 'B').toEqual(
    ...
    expect(shifters.hour.floor(new Date('2012-11-04T03:30:00-08:00'), tz), 'E').toEqual(
